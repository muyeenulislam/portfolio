    ...
    <section>
      <div className="grid grid-cols-1 sm:grid-cols-12 items-center">
        <div className="col-span-7 text-left sm:text-left">
          ...
          <div>
            <button className="px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-primary-500 to-secondary-500 hover:bg-slate-200 text-white hover:scale-105 transition ease-in-out ">
              <Link
                href={
