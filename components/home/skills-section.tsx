      ...
      <div className="section-content">
        ...
        <div className="space-y-3">
          {groups.map((group) => (
            <div
              key={group.title}
              className="rounded-2xl border border-brand-200/18 bg-[linear-gradient(120deg,rgba(40,90,72,0.2),rgba(9,20,19,0.65))] px-4 py-4 transition hover:border-brand-200/45 sm:px-5"
            >
              <h3 className="font-heading text-lg font-semibold text-brand-100 sm:text-xl">
                {group.title}
              </h3>
